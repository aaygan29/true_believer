...
- `paper/PAPER.md` and `paper/PAPER.pdf`: the full manuscript with all seven figures and references.
...
All code, seeds, figures, and results files are available in the accompanying repository. All datasets are
public: ChangeMyView / Winning Arguments (Tan et al. 2016) and Persuasion-for-Good (Wang et al. 2019) via
ConvoKit, and the Knutson neuroforecasting data (Kuhnen and Knutson 2005). Raw data is not redistributed;
a manifest in the repository records sources and access.

## Note on what was NOT done for you

I did not submit anything and did not create any account. Submission is an action under your name and
requires your ORCID login, so the final upload and click are yours. The package above is complete and
ready for that step.
